...
class es extends en_gb
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['InsufficientPermissionsError'] = 'No tienes permiso para acceder a este salon';
        $strings['MissingReservationResourceError'] = 'No se ha seleccionado un salon';
        ...
        $strings['AllResources'] = 'Todos los Salones';
        ...
        $strings['ResourceCapacity'] = 'Este salon tiene una capacidad de %s personas';
        $strings['ResourceCapacityNone'] = 'Este salon tiene capacidad ilimitada';
        $strings['AddNewResource'] = 'Agregar nuevo salon';
        $strings['AddNewUser'] = 'Agregar nuevo usuario';
        $strings['AddResource'] = 'Agregar salon';
        ...
        $strings['ResourcePermissions'] = 'Permisos del salon';
        ...
        $strings['ResourceList'] = 'Salones a reservar';
        ...
        $strings['ReservationRequiresApproval'] = 'Uno o más de los Salones reservados requieren aprobación antes de su uso. Esta reserva queará pendiente hasta que sea aprobada.';
        $strings['YourReferenceNumber'] = 'Tu número de referencia es %s';
        $strings['ChangeUser'] = 'Cambiar usuario';
        $strings['MoreResources'] = 'Más Salones';
        ...
        $strings['AddResources'] = 'Agregar Salones';
        ...
        $strings['AllResourcesOn'] = 'Todos los Salones habilitados';
        ...
        $strings['DeleteGroupWarning'] = 'Al borrar este grupo se eliminarán todos los permisos de los Salones asociados.  Los usuarios en este grupo pueden perder acceso a los Salones.';
        ...
        $strings['DeleteResourceWarning'] = 'Al borrar este salon se eliminarán todos los datos asociados, incluyendo';
        ...
        $strings['UserPermissionInfo'] = 'El acceso real a los Salones puede ser diferente dependiendo de los roles del usuario, permisos de grupo, o ajustes externos de permisos';
        ...
        $strings['MoveResourcesAndReservations'] = 'Mover Salones y reservas a';
        ...
        $strings['NoResourceAdministratorLabel'] = '(No hay administrador de salon)';
        $strings['WhoCanManageThisResource'] = '¿Quién puede administrar este salon?';
        $strings['ResourceAdministrator'] = 'Administrador de salon';
        ...
        $strings['ReservedResources'] = 'salon reservado';
        $strings['ReservedAccessories'] = 'Accesorio reservado';
        $strings['ResourceUsageTimeBooked'] = 'Uso de salon - tiempo reservado';
        $strings['ResourceUsageReservationCount'] = 'Uso de salon - número de reservas';
        ...
        $strings['ResourceFilter'] = 'Filtro de Salones';
        $strings['ResourceGroups'] = 'Grupos de Salones';
        ...
        $strings['ResourceGroupHelp1'] = 'Arrastra los grupos de Salones a organizar.';
        $strings['ResourceGroupHelp2'] = 'Haz clic con el botón derecho sobre el nombre de un grupo de Salones para acciones adicionales.';
        $strings['ResourceGroupHelp3'] = 'Arrastra los Salones para agregarlos a los grupos.';
        $strings['ResourceGroupWarning'] = 'Si usas los grupos de Salones, cada salon debe estar asignado al menos a un grupo. Los Salones no asignados no estarán disponibles para ser reservados.';
        $strings['ResourceType'] = 'Tipo de salon';
        $strings['AppliesTo'] = 'Aplica a';
        $strings['UniquePerInstance'] = 'Único por instancia';
        $strings['AddResourceType'] = 'Agregar tipo de salon';
        $strings['NoResourceTypeLabel'] = '(no está establecido el tipo de salon)';
        ...
        $strings['ResourceStatus'] = 'Estado del salon';
        $strings['CurrentStatus'] = 'Estado actual';
        $strings['AllReservationResources'] = 'Todos los Salones de las reservas';
        $strings['File'] = 'Fichero';
        $strings['BulkResourceUpdate'] = 'Actualización masiva de Salones';
        ...
        $strings['More'] = 'Más';
        $strings['ResourceAvailability'] = 'Disponibilidad del salon';
        ...
        $strings['AllResourceTypes'] = 'Todos los tipos de Salones';
        $strings['AllResourceStatuses'] = 'Todos los estados de los Salones';
        ...
        $strings['ResourceColor'] = 'Color del salon';
        ...
        $strings['ResourceDisplayPrompt'] = 'salon a mostrar';
        ...
        $strings['UsersWithAccessToResources'] = 'Usuarios con acceso a Salones';
        ...
        $strings['AnyResource'] = 'Cualquier salon';
        ...
        $strings['IcsLocationsAsResources'] = 'Las ubicaciones serán importadas como Salones.';
        ...
        $strings['ImportResources'] = 'Importar Salones';
        $strings['ExportResources'] = 'Exportar Salones';
        $strings['ResourceImportInstructions'] = '<ul><li>El fichero debe tener formato CSV con codificación UTF-8.</li><li>El nombre es un campo obligatorio. Dejar otros campos en blanco establecerá los valores por defecto.</li><li>Los estados disponibles son \'Disponible\', \'No disponible\' and \'Oculto\'.</li><li>El color será el formato hexadecimal. ex) #ffffff.</li><li>Las columnas de asignación y aprobación automática pueden ser verdadero o falso.</li><li>La validez del atributo no se aplicará.</li><li>Separar por comas los grupos de Salones.</li><li>Utilice la plantilla suministrada como ejemplo.</li></ul>';
        $strings['ReservationImportInstructions'] = '<ul><li>El fichero debe tener formato CSV con codificación UTF-8.</li><li>Correo electrónico, nombre del salon, comienzo y finalización son campos obligatorios.</li><li>Comienzo y finalización requieren la fecha completa. El formato recomendado es YYYY-mm-dd HH:mm (2017-12-31 20:30).</li><li>Las reglas, los conflictos y los intervalos de tiempo válidos no serán verificados.</li><li>No se enviarán notificaciones.</li><li>La validez del atributo no se aplicará.</li><li>Separar por comas los grupos de Salones.</li><li>Utilice la plantilla suministrada como ejemplo.</li></ul>';
        ...
        $strings['UpdateResourcesOnImport'] = 'Actualizar los Salones existentes si el nombre ya existe';
        ...
        $strings['SlackNotFound'] = 'No hemos podido encontrar ningún salon con ese nombre. Reservar ahora para comenzar una nueva reserva.';
        ...
        $strings['ConcurrentYes'] = 'Los Salones pueden ser reservados por más de una persona a la vez';
        $strings['ConcurrentNo'] = 'Los Salones no pueden ser reservados por más de una persona a la vez';
        ...
        $strings['ResourceImages'] = 'Salones de Imagenes';
        ...
        $strings['NoResourcePermission'] = 'No tienes permisos para acceder uno o más de los Salones requeridos';
        ...
        $strings['AccessoryResourceRequiredErrorMessage'] = 'El accesorio %s solamente puede reservarse con los Salones %s';
        ...
        $strings['AccessoryResourceAssociationErrorMessage'] = 'El accesorio \'%s\' no puede reservarse con los Salones solicitados';
        $strings['NoResources'] = 'No has agregado ningún salon.';
        ...
        $strings['ManageResources'] = 'Salones';
        ...
        $strings['ResourceCalendar'] = 'Calendario de Salones';
        ...
        $strings['ResourceReservations'] = 'Reservas de Salones';
        ...
        $strings['ManageResourceGroups'] = 'Grupos de Salones';
        $strings['ManageResourceTypes'] = 'Tipos de Salones';
        $strings['ManageResourceStatus'] = 'Estados de Salones';
