...
$conf['settings']['script.url'] = 'http://localhost/nw/newbooked/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
