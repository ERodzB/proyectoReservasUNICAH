 ...
 */
$conf['settings']['app.title'] = 'Control de Reservas de Laboratorios y Audiovisuales UNICAH';			// application title
...
$conf['settings']['database']['user'] = 'UNICAH';        // database user with permission to the booked database
