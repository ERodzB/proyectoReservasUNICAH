 ...
 */
$conf['settings']['app.title'] = 'Reservas Unicah';			// application title
$conf['settings']['default.timezone'] = 'America/Tegucigalpa';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'false';         	// if users can register themselves
$conf['settings']['admin.email'] = 'admin@unicah.edu';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://localhost/nw/proyectoReservasUNICAH/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['home.url'] = 'http://unicah.edu'; 	      					// the url to open when the logo is clicked
...
$conf['settings']['privacy']['view.reservations'] = 'true';    			// if unauthenticated users can view reservations
